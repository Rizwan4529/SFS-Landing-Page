...
export function TrustPreLaunch() {
  return (
    <section id="trust" className="section-anchor bg-bg-alt px-gutter py-section">
        ...
        <div className="mx-auto mb-14 max-w-[680px] text-center">
          ...
          <Reveal delay={0.12}>
            <p className="mx-auto mt-6 max-w-[560px] text-[19px] leading-[1.7] text-muted">
              Share Fund System is launching soon. Join the waitlist now to learn how the platform
              works and be first in line for early access when we go live.
            </p>
          </Reveal>
        </div>
        ...
        <div className="grid grid-cols-1 gap-[18px] sm:grid-cols-2">
          {PILLARS.map((pillar) => (
            ...
            >
              ...
              <p className="mt-2 text-[14.5px] leading-snug text-muted-soft">{pillar.desc}</p>
            </CategoryCard>
          ))}
        </div>
      </div>
