            ...
            cat.featured ? (
              ...
              >
                ...
                <div className="relative">
                  <h3 className="m-0 font-display text-[25px] font-bold tracking-tight text-white">
                    {cat.title}
                  </h3>
                  <p className="mt-2 text-base leading-snug text-[rgba(206,218,242,0.78)]">
                    {cat.desc}
                  </p>
                </div>
              </CategoryCard>
              ...
              >
                ...
                <div>
                  <h3 className="m-0 font-display text-xl font-bold tracking-tight text-ink-heading">
                    {cat.title}
                  </h3>
                  <p className="mt-2 text-[15px] leading-normal text-muted-soft">
                    {cat.desc}
                  </p>
                </div>
              </CategoryCard>
          ...
          >
            ...
            <div className="min-w-[260px] flex-1">
              ...
              <p className="mt-2 max-w-[620px] text-[16.5px] leading-snug text-[#5b5333]">
                Startup, expansion, equipment, and operations — funding to help
